...
| :---: | :--- | :---: | :---: | :--- | :--- | :---: | :---: | :--- | :--- |
| Ruby | activesupport | 7.0.8 | MIT | A toolkit of support libraries and Ruby core extensions extracted from the Rails framework | <https://rubyonrails.org> | 2023-06-12 | Low | Provide the deep symbolize and stringify methods on hash | Most popular gem on rubygems |
...
| Ruby | rubocop | 1.56.3 | MIT | RuboCop is a Ruby code style checking and code formatting tool. | <https://rubocop.org/> | 2023-06-12 | Low | Ruby linter | Most popular gem on rubygems |
