...
| :---: | :--- | :---: | :---: | :--- | :--- | :---: | :---: | :--- | :--- |
| Ruby | activesupport | 7.2.2 | MIT | A toolkit of support libraries and Ruby core extensions extracted from the Rails framework | <https://rubyonrails.org> | 2023-06-12 | Low | Provide the deep symbolize and stringify methods on hash | Most popular gem on rubygems |
...
| Ruby | benchmark | 0.3.0 | Ruby | a performance benchmarking library | <https://github.com/ruby/benchmark> | 2024-11-01 | Low | Dependency | Dependency |
...
| Ruby | json | 2.7.5 | Ruby | This is a JSON implementation as a Ruby extension in C. | <https://ruby.github.io/json> | 2023-06-12 | Low | Dependency | Dependency |
...
| Ruby | minitest | 5.25.1 | MIT | minitest provides a complete suite of testing facilities supporting | <https://github.com/minitest/minitest> | 2023-06-12 | Low | Dependency | Dependency |
...
| Ruby | parser | 3.3.5.1 | MIT | A Ruby parser written in pure Ruby. | <https://github.com/whitequark/parser> | 2023-06-12 | Low | Dependency | Dependency |
