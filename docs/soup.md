...
| Ruby | concurrent-ruby | 1.3.1 | MIT | Modern concurrency tools including agents, futures, promises, thread pools, actors, supervisors, and more. | <http://www.concurrent-ruby.com> | 2023-06-12 | Low | Dependency | Dependency |
...
| Ruby | minitest | 5.23.1 | MIT | minitest provides a complete suite of testing facilities supporting | <https://github.com/minitest/minitest> | 2023-06-12 | Low | Dependency | Dependency |
...
| Ruby | parser | 3.3.2.0 | MIT | A Ruby parser written in pure Ruby. | <https://github.com/whitequark/parser> | 2023-06-12 | Low | Dependency | Dependency |
...
| Ruby | rubocop | 1.64.0 | MIT | RuboCop is a Ruby code style checking and code formatting tool. | <https://rubocop.org/> | 2023-06-12 | Low | Ruby linter | Most popular gem on rubygems |
...
| Ruby | rubocop-capybara | 2.20.0 | MIT |   Code style checking for Capybara test files (RSpec, Cucumber, Minitest). | <https://github.com/rubocop/rubocop-capybara> | 2024-05-30 | Low | Dependency | Dependency |
| Ruby | rubocop-factory_bot | 2.25.1 | MIT | Code style checking for factory_bot files. | <https://github.com/rubocop/rubocop-factory_bot> | 2024-05-30 | Low | Dependency | Dependency |
...
| Ruby | rubocop-rspec_rails | 2.28.3 | MIT | Code style checking for RSpec Rails files. | <> | 2024-05-30 | Low | Dependency | Dependency |
